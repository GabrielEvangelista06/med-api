...
class ConsultaControllerTest
{
	...
	@Test
	@DisplayName("Deveria devolver o código HTTP 400 quando as informações de agendamento forem inválidas")
	@WithMockUser
	...
	@Test
	@DisplayName("Deveria devolver o código HTTP 200 quando as informações de agendamento forem válidas")
	@WithMockUser
	void agendarCenario2() throws Exception
	{
		...
		MockHttpServletResponse response = mvc.perform(post("/consultas").contentType(MediaType.APPLICATION_JSON)
						.content(this.dadosAgendamentoConsultaJson.write(new DadosAgendamentoConsulta(2l, 5l, data, especialidade)).getJson()))
